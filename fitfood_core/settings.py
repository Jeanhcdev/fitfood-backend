"""
Django settings for fitfood_backend project.
...
SECRET_KEY = 'django-insecure-pp9rs&z7#b3)g&5%+bp*y@%a1$+e8p%-m%^e=8_19tbhf8mmc)'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'False').lower() == 'true'

# Lista de hosts permitidos por defecto para desarrollo local
ALLOWED_HOSTS = ['127.0.0.1', 'localhost']

# Añade el host de Render si la variable de entorno existe
...
ROOT_URLCONF = 'fitfood_core.urls'
...
WSGI_APPLICATION = 'fitfood_core.wsgi.application'

ASGI_APPLICATION = 'fitfood_core.asgi.application'
